...
; realizzare un programma in assembly che faccia la somma dei numeri da 1 a 93: 
org 100h
...
cmp cx, 93 ; faccio il confronto, tra il contatore e 93, perche' il cx mi conta anche quante somme stp facendo.
