rem Fare un script di shell ( a scelta: cmd.exe per windows, bash per linux) che calcoli il giorno Giuliano (Julian day) di una data a scelta o di sistema e mostri a schermo il calendario del mese di partenza e dei due mesi successivi.
@echo off
