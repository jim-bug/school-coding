...
public class Esercizio3 extends JFrame{
	private JLabel name;
...
//								 result = num1/num2;
							...
							JOptionPane.showMessageDialog(name, result.toString(), "Risultato operazione", JOptionPane.INFORMATION_MESSAGE);
//							 resultTotal.setText(result.toString());
							
						}
						catch(Exception e1) {
							JOptionPane.showMessageDialog(name, "NULL", "Risultato operazione", JOptionPane.INFORMATION_MESSAGE);
